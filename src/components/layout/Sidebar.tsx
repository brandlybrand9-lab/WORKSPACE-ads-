...
import { LayoutDashboard, CheckSquare, Users, Briefcase, Settings, LogOut } from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 border-e border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950 flex flex-col h-full">
